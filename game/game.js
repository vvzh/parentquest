...
(function () {
	...
	game.locations = {
		...
		'l5n1': {
			...
			'text': "Конфликты часто напоминают хождение по цирковой арене с выполнением одних и тех же действий участниками представления на радость зрителю! Рычащие львы, плачущие клоуны, и, нарочито правильно, выполняющие команды дрессировщика разукрашенные собачки, сменяют друг друга, не внося ничего нового в Жизнь зрителя. Представление за представлением, в котором можно скоротать время от скуки и повседневных дел – вот что собою представляет среднестатисческое заведение типа «Цирк-Конфликт»...",
			'ways': [{
				'text': "Продолжить",
				'target': 'l5',
			}],
